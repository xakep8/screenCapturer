...
namespace screen_recorder
{
    ...
    public:
        DesktopCapture();
        ~DesktopCapture();
        void captureThumbnail(Window windowId, const std::string &filename);
        void stopCapture();
        void startCapture(Window windowId, const std::string &filename, int fps, int duration_seconds);
    };
}
#endif